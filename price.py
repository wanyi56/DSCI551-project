...
def chewy(k):
    ...
    # chewy
    driver_chewy = webdriver.Chrome(chrome_options=options)
    # chewy
...
def petsmart(k):    #petsmart
    driver_petsmart = webdriver.Chrome(chrome_options=options)
...
@ray.remote
def petco(k):    #petco
    driver_petco = webdriver.Chrome(chrome_options=options)
